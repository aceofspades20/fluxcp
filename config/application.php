...
return array(
	'ServerAddress'				=> '51.79.205.173',				// This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'					=> '/',						// The base URI is the base web root on which your application lies.
	'InstallerPassword'			=> 'c9p5au8naa',		// Installer/updater password.
	...
	'SiteTitle'					=> 'Genesis Ragnarok Online',	// This value is only used if the theme decides to use it.
